...
Route::get ('/dasbor/dosen/berita', 'Simta\Controllers\BeritaController@dasborLihatDaftarBerita');
Route::get ('/dasbor/dosen/berita/baru', 'Simta\Controllers\BeritaController@dasborTambahkanBerita');
Route::post('/dasbor/dosen/berita/baru', 'Simta\Controllers\BeritaController@dasborSimpanBeritaBaru');
Route::get ('/dasbor/dosen/berita/sunting/{id_berita}', 'Simta\Controllers\BeritaController@dasborSuntingBerita');
Route::post('/dasbor/dosen/berita/sunting/{id_berita}', 'Simta\Controllers\BeritaController@dasborSimpanPerubahanBerita');
Route::get ('/dasbor/dosen/berita/hapus/{id_berita}', 'Simta\Controllers\BeritaController@dasborHapusBerita');
...
Route::get ('/dasbor/dosen/panduan', 'Simta\Controllers\PanduanController@dasborLihatDaftarPanduan');
Route::get ('/dasbor/dosen/panduan/baru', 'Simta\Controllers\PanduanController@dasborTambahkanPanduan');
Route::post('/dasbor/dosen/panduan/baru', 'Simta\Controllers\PanduanController@dasborSimpanPanduanBaru');
Route::get ('/dasbor/dosen/panduan/sunting/{id_panduan}', 'Simta\Controllers\PanduanController@dasborSuntingPanduan');
Route::post('/dasbor/dosen/panduan/sunting/{id_panduan}', 'Simta\Controllers\PanduanController@dasborSimpanPerubahanPanduan');
Route::get ('/dasbor/dosen/panduan/hapus/{id_panduan}', 'Simta\Controllers\PanduanController@dasborHapusPanduan');
...
Route::get ('/dasbor/dosen/bidang_keahlian', 'Simta\Controllers\BidangKeahlianController@dasborLihatDaftarBidangKeahlian');
Route::get ('/dasbor/dosen/bidang_keahlian/baru', 'Simta\Controllers\BidangKeahlianController@dasborTambahkanBidangKeahlian');
Route::post('/dasbor/dosen/bidang_keahlian/baru', 'Simta\Controllers\BidangKeahlianController@dasborSimpanBidangKeahlianBaru');
Route::get ('/dasbor/dosen/bidang_keahlian/sunting/{id_bidang_keahlian}', 'Simta\Controllers\BidangKeahlianController@dasborSuntingBidangKeahlian');
Route::post('/dasbor/dosen/bidang_keahlian/sunting/{id_bidang_keahlian}', 'Simta\Controllers\BidangKeahlianController@dasborSimpanPerubahanBidangKeahlian');
Route::get ('/dasbor/dosen/bidang_keahlian/hapus/{id_bidang_keahlian}', 'Simta\Controllers\BidangKeahlianController@dasborHapusBidangKeahlian');
